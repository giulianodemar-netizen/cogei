...
// Recupera info utente HSE
$hse_user = get_userdata($assignment['target_user_id']);
$hse_name = $hse_user ? $hse_user->display_name : 'Utente HSE';
...
<body>
    <div class="container">
        ...
        <div class="hse-info">
            <p><strong>Utente HSE Valutato:</strong> <?php echo esc_html($hse_name); ?></p>
            <p style="margin-top: 5px; font-size: 14px; color: #666;">
                Questo questionario valuta l'operato dell'utente HSE selezionato.
            </p>
        </div>
